...
export default class {
  ...
  __getSessions () {
    return new Promise ((resolve, reject) => {
      suppServ.then(res => {
        ...
        new res.default().sessions(__payload).then(d => {
          resolve(d.data)
        }).catch(e => reject(e))
  ...
  async render () {
    ...
    this.template.innerHTML = `
      <section class="row">
        <div class="col-1">
          <i class="material-icons md-48" style="color:#03A9F4;">security</i>
        </div>
        <div class="col-11 pt-3"><span class="text-muted">Login Sessions</span></div>
    </section>
    <hr/>
