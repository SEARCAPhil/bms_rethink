          ...
          <div class="col-2">
            ...
            <div class="dropdown-section float-right" id="dropdown-${opt.id}">
              <ul class="list-group list-group-flush">
                <li class="list-group-item"><a href="#" onclick="event.preventDefault();window.open('${ApiConfig.url}/bidding/invitations/attachments/download.php?id=${opt.id}')">Download</a></li>
