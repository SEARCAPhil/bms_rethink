...
export default class {
  ...
  async create(e) {
    ...
    let otherSpecsToBeRemoved = document.getElementById('specsToBeRemoved')
    otherSpecsToBeRemoved = otherSpecsToBeRemoved ? otherSpecsToBeRemoved.value : JSON.stringify([])
		...
		let __payload = {
			...
			original,
      others,
      otherSpecsToBeRemoved : JSON.parse(otherSpecsToBeRemoved) ,
